...
export const ACTION_LABELS: Record<string, string> = {
  ...
  "play.enable": "turned on Backstage Play",
  "play.disable": "turned off Backstage Play",
  "play.session": "opened Backstage Play",
  "play.action": "acted from Backstage Play",
  "play.level_up": "levelled up in Backstage Play",
  "play.badge": "earned a Play badge",
  "play.quest_complete": "completed a Play quest",
  "play.settings_changed": "changed Play settings",
  "play.season_reset": "reset the Play season",
  "task.checklist_done": "ticked a checklist item",
